        ...
        <nav class="flex items-center justify-end gap-4">
            @auth
                <a href="{{ url('/dashboard') }}"
                   class="inline-block px-5 py-1.5 dark:text-[#EDEDEC] border-[#19140035] hover:border-black">
                    Dashboard
                </a>
            @else
                <a href="{{ route('login') }}" class="text-sm font-medium text-zinc-600 dark:text-zinc-400">
                    Log in
                </a>
            @endauth
        </nav>
...
<main class="w-full lg:max-w-4xl">
    <!-- ✅ Popular Movies -->
    <h1 class="text-2xl font-bold mb-4 text-center dark:text-white">Popular Movies</h1>
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-10">
        @foreach($popularMovies as $movie)
            <div class="bg-neutral-100 dark:bg-zinc-800 rounded-lg p-3 shadow hover:scale-105 transition-all">
                <img src="https://image.tmdb.org/t/p/w500{{ $movie['poster_path'] }}"
                     alt="{{ $movie['title'] }}"
                     class="rounded-md mb-2">
                <h2 class="text-sm font-semibold truncate dark:text-white">{{ $movie['title'] }}</h2>
    ...
    <!-- ✅ Popular TV Shows -->
    <h1 class="text-2xl font-bold mb-4 text-center dark:text-white">Popular TV Shows</h1>
        ...
        @foreach($popularTvShows as $show)
            <div class="bg-neutral-100 dark:bg-zinc-800 rounded-lg p-3 shadow hover:scale-105 transition-all">
                <img src="https://image.tmdb.org/t/p/w500{{ $show['poster_path'] }}"
                     alt="{{ $show['name'] }}"
                     class="rounded-md mb-2">
                <h2 class="text-sm font-semibold truncate dark:text-white">{{ $show['name'] }}</h2>
                <p class="text-xs text-zinc-500 dark:text-zinc-400">
